...
const AddFlightForm = () => {
  ...
  const retrieveAllAirplanes = async () => {
    const response = await axios.get(
      "http://localhost:8086/api/airplane/fetch/all",
      {
        headers: {
  ...
  const retrieveAllAirport = async () => {
    const response = await axios.get(
      "http://localhost:8086/api/airport/fetch/all"
    );
    console.log(response.data);
    return response.data;
  };
  ...
  const retrieveAllFlightStatus = async () => {
    const response = await axios.get(
      "http://localhost:8086/api/flight/status/all",
      {
        headers: {
          Authorization: "Bearer " + admin_token, // Replace with your actual JWT token
        },
  ...
  const saveFlight = (e) => {
    ...
    fetch("http://localhost:8086/api/flight/add", {
      method: "POST",
      headers: {
