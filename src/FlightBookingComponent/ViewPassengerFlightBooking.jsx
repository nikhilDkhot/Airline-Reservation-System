...
const ViewPassengerFlightBooking = () => {
  ...
  const retrieveAllBookedFlights = async () => {
    const response = await axios.get(
      "http://localhost:8086/api/flight/book/fetch/user?userId=" + passenger.id,
      {
        headers: {
  ...
  const cancelFlightTicket = (bookingId) => {
    fetch(
      "http://localhost:8086/api/flight/book/ticket/cancel?bookingId=" +
        bookingId,
      {
        method: "DELETE",
        headers: {
  ...
  const downloadTicket = (bookingId) => {
    fetch(
      `http://localhost:8086/api/flight/book/download/ticket?bookingId=${bookingId}`,
      {
        method: "GET",
        headers: {
          Authorization: "Bearer " + passenger_token,
